...
public final class AnimatorSet extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo58clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo58clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m59clone = next.m59clone();
            hashMap.put(next, m59clone);
            animatorSet.mNodes.add(m59clone);
            animatorSet.mNodeMap.put(m59clone.animation, m59clone);
            ArrayList arrayList = null;
            m59clone.dependencies = null;
            m59clone.tmpDependencies = null;
            m59clone.nodeDependents = null;
            m59clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m59clone.animation.getListeners();
            if (listeners != null) {
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m59clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo58clone();
                return node;
