...
public class PropertyValuesHolder implements Cloneable {
    ...
    @Override // 
    /* renamed from: clone */
    public PropertyValuesHolder mo62clone() {
        try {
            PropertyValuesHolder propertyValuesHolder = (PropertyValuesHolder) super.clone();
            propertyValuesHolder.mPropertyName = this.mPropertyName;
            propertyValuesHolder.mProperty = this.mProperty;
            propertyValuesHolder.mKeyframeSet = this.mKeyframeSet.mo60clone();
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // com.nineoldandroids.animation.PropertyValuesHolder
        /* renamed from: clone */
        public IntPropertyValuesHolder mo62clone() {
            IntPropertyValuesHolder intPropertyValuesHolder = (IntPropertyValuesHolder) super.mo62clone();
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // com.nineoldandroids.animation.PropertyValuesHolder
        /* renamed from: clone */
        public FloatPropertyValuesHolder mo62clone() {
            FloatPropertyValuesHolder floatPropertyValuesHolder = (FloatPropertyValuesHolder) super.mo62clone();
