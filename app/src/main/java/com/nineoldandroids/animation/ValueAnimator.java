...
public class ValueAnimator extends Animator {
    ...
    */
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator mo58clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo58clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder mo62clone = propertyValuesHolderArr[i2].mo62clone();
                valueAnimator.mValues[i2] = mo62clone;
                valueAnimator.mValuesMap.put(mo62clone.getPropertyName(), mo62clone);
            }
        }
        return valueAnimator;
    }
