...
public class WifiConenction extends BaseConnection {
            ...
            handler.postDelayed(new Runnable() { // from class: com.home.net.WifiConenction.1
                ...
                public void run() {
                    if (WifiConenction.this.k != arrayList.size()) {
                        int[] iArr = {126, 255, 6, i, ((MyColor) arrayList.get(WifiConenction.this.k)).r, ((MyColor) arrayList.get(WifiConenction.this.k)).g, ((MyColor) arrayList.get(WifiConenction.this.k)).b, arrayList.size(), 239};
    ...
    public void code_check(int i, int i2) throws Exception {
        write(new int[]{126, 255, 10, i, i2, 255, 255, 255, 239});
    }
