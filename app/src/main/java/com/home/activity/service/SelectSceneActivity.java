...
public class SelectSceneActivity extends LedBleActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.bedRoomLayout /* 2131296349 */:
                mustDo();
                ...
                return;
            case R.id.diningLayout /* 2131296547 */:
                mustDo();
                ...
                return;
            case R.id.kitchenLayout /* 2131296817 */:
                mustDo();
                ...
                return;
            case R.id.livingRoomLayout /* 2131296876 */:
                mustDo();
                ...
                return;
            case R.id.ll_ledlike /* 2131296964 */:
                mustDo();
                ...
                return;
            case R.id.looLayout /* 2131296996 */:
                mustDo();
                ...
                return;
            case R.id.recreationLayout /* 2131297168 */:
                mustDo();
                ...
                return;
            case R.id.studyLayout /* 2131297446 */:
                mustDo();
                findViewById(R.id.ivStudy).setVisibility(0);
                this.lastSelectedItemResId = R.id.ivStudy;
                ImageDispose.Bitmap2Bytes(BitmapTool.Drawable2Bimap(this, R.drawable.ledwifi));
                return;
            case R.id.textViewNavLeft /* 2131297500 */:
                setResult(0, intent);
                finish();
                return;
            case R.id.textViewNavRight /* 2131297501 */:
                ...
                finish();
                return;
            case R.id.workLayout /* 2131297916 */:
                mustDo();
