...
public class MainActivity_DMX03 extends LedBleActivity implements NetExceptionInterface, SensorEventListener, ActionSheet.ActionSheetListener, MyReceiver.MyListener, IListener, GPS_Interface {
    ...
    private void initView() {
        ...
        if (sceneBean.equalsIgnoreCase("LEDDMX-00-")) {
            ...
            this.codeTV.setVisibility(View.GONE);
        }
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.soundPool = new SoundPool.Builder().setAudioAttributes(new AudioAttributes.Builder().setUsage(AudioAttributes.USAGE_GAME).setContentType(4).build()).build();
        } else {
        ...
        if (sceneBean.equalsIgnoreCase("LEDDMX-03-")) {
            this.rgBottomDmx03.setVisibility(View.VISIBLE);
            this.rgBottomDmx03.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.home.activity.main.MainActivity_DMX03.5
                ...
                public void onCheckedChanged(RadioGroup radioGroup, int i) {
                    MainActivity_DMX03.this.ivLeftMenu.setVisibility(View.GONE);
                    MainActivity_DMX03.this.textViewConnectCount.setVisibility(View.GONE);
                    switch (i) {
                        case R.id.rbModeDmx03 /* 2131297112 */:
                            MainActivity_DMX03.this.isTime = 1;
                            MainActivity_DMX03.this.currentIndex = 1;
                            MainActivity_DMX03.this.segmentMusic.setVisibility(View.GONE);
                            MainActivity_DMX03.this.onOffButton.setVisibility(View.GONE);
                            MainActivity_DMX03.this.btnModePlay.setVisibility(View.VISIBLE);
                            MainActivity_DMX03.this.btnTimerAdd.setVisibility(View.GONE);
                            MainActivity_DMX03.this.btnChangeColor.setVisibility(View.GONE);
                            MainActivity_DMX03.this.ivEditColor.setVisibility(View.GONE);
                            MainActivity_DMX03.this.segmentRgb.setVisibility(View.GONE);
                            ...
                            break;
                        case R.id.rbMusicDmx03 /* 2131297119 */:
                            MainActivity_DMX03.this.isTime = 1;
                            MainActivity_DMX03.this.currentIndex = 3;
                            MainActivity_DMX03.this.segmentMusic.setVisibility(View.VISIBLE);
                            MainActivity_DMX03.this.onOffButton.setVisibility(View.GONE);
                            MainActivity_DMX03.this.btnModePlay.setVisibility(View.GONE);
                            MainActivity_DMX03.this.btnTimerAdd.setVisibility(View.GONE);
                            MainActivity_DMX03.this.segmentRgb.setVisibility(View.GONE);
                            if (MainActivity_DMX03.this.musicFragment.isCheckSegmentedRadioGroupIndexTwo()) {
                                MainActivity_DMX03.this.ivEditColor.setVisibility(View.VISIBLE);
                                MainActivity_DMX03.this.btnChangeColor.setVisibility(View.GONE);
                            } else {
                                MainActivity_DMX03.this.ivEditColor.setVisibility(View.GONE);
                                MainActivity_DMX03.this.btnChangeColor.setVisibility(View.GONE);
                            ...
                            MainActivity_DMX03.this.onOffButton.setBackgroundResource(R.drawable.on_btn);
                            MainActivity_DMX03.this.tvTopTitle.setVisibility(View.GONE);
                            MainActivity_DMX03.this.musicFragment.startMusice();
                            break;
                        case R.id.rbRGBDmx03 /* 2131297126 */:
                            MainActivity_DMX03.this.currentIndex = 0;
                            MainActivity_DMX03.this.ivLeftMenu.setVisibility(View.VISIBLE);
                            MainActivity_DMX03.this.textViewConnectCount.setVisibility(View.VISIBLE);
                            MainActivity_DMX03.this.segmentMusic.setVisibility(View.GONE);
                            MainActivity_DMX03.this.onOffButton.setVisibility(View.VISIBLE);
                            MainActivity_DMX03.this.btnModePlay.setVisibility(View.GONE);
                            MainActivity_DMX03.this.btnTimerAdd.setVisibility(View.GONE);
                            MainActivity_DMX03.this.btnChangeColor.setVisibility(View.GONE);
                            MainActivity_DMX03.this.ivEditColor.setVisibility(View.GONE);
                            ...
                            MainActivity_DMX03.this.editor.commit();
                            MainActivity_DMX03.this.onOffButton.setBackgroundResource(R.drawable.on_btn);
                            MainActivity_DMX03.this.tvTopTitle.setVisibility(View.VISIBLE);
                            MainActivity_DMX03.this.tvTopTitle.setText(MainActivity_DMX03.this.getString(R.string.tab_reg));
                            MainActivity_DMX03.this.pauseMusicAndVolum(true);
                            break;
                        case R.id.rbTimerDmx03 /* 2131297141 */:
                            MainActivity_DMX03.this.isTime = 1;
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.ivRefresh /* 2131296751 */:
                    ...
                    MainActivity_DMX03.this.refreshDevices();
                    MainActivity_DMX03.this.startAnimation(view);
                    return;
                ...
                case R.id.iv_all11 /* 2131296771 */:
                    ...
                    new Handler().postDelayed(new Runnable() { // from class: com.home.activity.main.MainActivity_DMX03.MyOnClickListener.2
                        ...
                        public void run() {
                            ...
                            LedBleApplication.getApp().setCanConnect(false);
                            MainActivity_DMX03.this.refreshDevices();
                            MainActivity_DMX03.this.backTextView.setVisibility(View.VISIBLE);
                        }
                    }, 2000L);
                ...
                case R.id.iv_all22 /* 2131296772 */:
                    MainActivity_DMX03.this.backTextView.setVisibility(View.INVISIBLE);
                    LedBleApplication.getApp().setAuto(true);
                    MainActivity_DMX03.this.devices_connect.setVisibility(View.VISIBLE);
                    MainActivity_DMX03.this.iv_all11.setVisibility(View.VISIBLE);
                    MainActivity_DMX03.this.rl_alldevices.setVisibility(View.GONE);
                    MainActivity_DMX03.this.iv_all22.setVisibility(View.GONE);
                    MainActivity_DMX03.this.linearLayoutBottom.setVisibility(View.VISIBLE);
                    MainActivity_DMX03.this.clearList();
                ...
                case R.id.onOffButton /* 2131297049 */:
                    if (MainActivity_DMX03.this.isLightOpen) {
    ...
    protected void refreshDevices() {
        if (ServicesFragment.getBluetoothAdapter() != null && !ServicesFragment.getBluetoothAdapter().isEnabled()) {
            ...
            new Handler().postDelayed(new Runnable() { // from class: com.home.activity.main.MainActivity_DMX03.10
                @Override // java.lang.Runnable
                public void run() {
                    MainActivity_DMX03.this.stopLeScan(true);
                }
            }, 6000L);
        }
    }
        ...
        if (mActivity != null) {
            ...
            new AlertDialog.Builder(mActivity).setTitle(R.string.please_input).setIcon(17301659).setView(editText).setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() { // from class: com.home.activity.main.MainActivity_DMX03.12
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    for (Group group : new GroupDeviceDao(MainActivity_DMX03.mActivity).getAllgroup()) {
                        if (group.getGroupName().equalsIgnoreCase(obj)) {
    ...
    private int findConnectCount(ArrayList<GroupDevice> arrayList) {
        ...
        for (GroupDevice next : arrayList) {
    ...
    public void onOtherButtonClick(ActionSheet actionSheet, int i, String str) {
        if (i != 0) {
            ...
            if (str.equalsIgnoreCase("")) {
                ...
                this.textViewConnectCount.setText(NetConnectBle.getInstance().getDevicesByGroup().size());
            }
        } else {
            Toast.makeText(getApplicationContext(), (int) R.string.no_device_found, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        if (i == 110) {
            ...
            switch (i) {
                ...
                case REQUEST_BLUETOOTH_SCAN | REQUEST_BLUETOOTH_CONNECT /* 224  && 225*/:
                    if (iArr.length <= 0 || iArr[0] != 0) {
                        return;
                    }
                    turnOnBluetooth();
        ...
        if (i2 == -1 && i == 111) {
            if (intent.getStringExtra("group") != null) {
                ...
                try {
                    ...
                    for (GroupView next : this.arrayListGroupViews) {
    ...
    public void setPassword() {
        ...
        SimpleDateFormat simpleDateFormat3 = new SimpleDateFormat("ss", Locale.US);
        ...
        if (mActivity.getweek() == 0) {
            Toast.makeText(mActivity, (int) R.string.choose, Toast.LENGTH_SHORT).show();
            return;
        }
        int i2 = (i << 5) | parseInt;
        String preference = SharePersistent.getPerference(this, Constant.PasswordSet);
        if (preference != null && preference.length() == 8) {
            NetConnectBle.getInstanceByGroup(this.groupName).setPassword(Integer.parseInt(preference.substring(0, 2), 16), Integer.parseInt(preference.substring(2, 4), 16), Integer.parseInt(preference.substring(4, 6), 16), Integer.parseInt(preference.substring(6, 8), 16), i2, parseInt2);
        } else {
