...
public class MainActivity_LIKE extends LedBleActivity implements NetExceptionInterface, SensorEventListener, ActionSheet.ActionSheetListener, MyReceiver.MyListener, IListener, GPS_Interface {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.buttonStrobe /* 2131296427 */:
                    ...
                    return;
                case R.id.buttonVoiceCtlBreathe /* 2131296428 */:
                    MainActivity_LIKE.mActivity.setLikeMode(0, true);
                    return;
                case R.id.buttonVoiceCtlFlash /* 2131296429 */:
                    MainActivity_LIKE.mActivity.setLikeMode(1, true);
                    return;
                case R.id.buttonVoiceCtlStrobe /* 2131296430 */:
    ...
    public void setRgb(int i, int i2, int i3) {
        ...
        if (this.canSend) {
            NetConnectBle.getInstanceByGroup(this.groupName).setRgb(i, i2, i3, sceneBean, false, false, false, false);
            this.canSend = false;
