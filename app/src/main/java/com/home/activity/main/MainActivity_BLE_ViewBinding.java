...
public class MainActivity_BLE_ViewBinding implements Unbinder {
    ...
    public MainActivity_BLE_ViewBinding(MainActivity_BLE mainActivity_BLE, View view) {
        ...
        mainActivity_BLE.activity_main = (LinearLayout) Utils.findRequiredViewAsType(view, R.id.llMenu, "field 'avtivity_main'", LinearLayout.class);
        ...
        mainActivity_BLE.segmentSmartTimer = (SegmentedRadioGroup) Utils.findRequiredViewAsType(view, R.id.segmentSmartTimer, "field 'segmentSmartTimer'", SegmentedRadioGroup.class);
        mainActivity_BLE.checkGroupWeek = (SelectMultiCheckGroup) Utils.findRequiredViewAsType(view, R.id.checkGroupWeek, "field 'checkGroupWeek'", SelectMultiCheckGroup.class);
    }
    ...
    public void unbind() {
        ...
        mainActivity_BLE.activity_main = null;
        ...
        mainActivity_BLE.segmentSmartTimer = null;
        mainActivity_BLE.checkGroupWeek = null;
    }
}
