...
public class ChioceTimeActivity extends LedBleActivity implements View.OnClickListener {
        ...
        if (recordMode != null) {
            if (recordMode.getMode() != null) {
                if (LedBleApplication.getApp().getSceneBean().contains(CommonConstant.LEDSUN)) {
                    ...
                    textView.setText("" + TimerFragment_sun.modeble[Integer.parseInt(this.recordMode.getMode())]);
                } else {
                    TextView textView2 = this.tvmode;
                    textView2.setText("" + TimeActivity.modeble[Integer.parseInt(this.recordMode.getMode())]);
                }
            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.no /* 2131297036 */:
                finish();
                return;
            case R.id.rl_mode /* 2131297271 */:
                mode();
                return;
            case R.id.rl_week /* 2131297281 */:
                this.hashMap.clear();
                week();
                return;
            case R.id.yes /* 2131297925 */:
