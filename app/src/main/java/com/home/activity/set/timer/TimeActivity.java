...
public class TimeActivity extends LedBleActivity {
    ...
    public void init() {
        ...
        findViewById(R.id.sure).setOnClickListener(new View.OnClickListener() { // from class: com.home.activity.set.timer.TimeActivity.5
            ...
            public void onClick(View view) {
                view.startAnimation(AnimationUtils.loadAnimation(TimeActivity.this, R.anim.layout_scale));
                if (TimeActivity.listDate.size() == 0) {
                    return;
                }
    ...
    /* JADX WARN: Type inference failed for: r3v2, types: [com.home.activity.main.MainActivity_BLE] */
    /* JADX WARN: Type inference failed for: r3v3, types: [com.home.activity.main.MainActivity_DMX02] */
    /* JADX WARN: Type inference failed for: r3v4, types: [com.home.activity.main.MainActivity_BLE] */
    /* JADX WARN: Type inference failed for: r3v5, types: [com.home.activity.main.MainActivity_DMX02] */
    ...
    public void sendTime(int i) {
        ...
        if (LedBleApplication.getApp().getSceneBean().contains("BLE") || LedBleApplication.getApp().getSceneBean().contains(BluetoothLeServiceSingle.LEDDMX) || LedBleApplication.getApp().getSceneBean().contains("WiFi")) {
            ...
            if (LedBleApplication.getApp().getSceneBean().contains("BLE")) {
                List<RecordMode> list = listDate;
                if (list != null && list.get(i).getMode() != null) {
                    this.mod = this.modeOrder[Integer.parseInt(listDate.get(i).getMode())];
                }
                ?? r3 = this.mActivity;
                if (r3 != 0) {
                    r3.sendTime(this.parameter, this.mod, r6, hour, minute, this.dayhour, this.dayminute);
                    return;
                }
                ?? r32 = this.mActivity_dmx02;
                if (r32 != 0) {
                    r32.sendTime(this.parameter, this.mod, r6, hour, minute, this.dayhour, this.dayminute);
                }
                ...
                int i3 = this.dmx[Integer.parseInt(listDate.get(i).getMode())];
                this.mod = i3;
                ?? r33 = this.mActivity;
                if (r33 != 0) {
                    r33.sendTime(this.parameter, i3, r6, hour, minute, this.dayhour, this.dayminute);
                    return;
                }
                ?? r34 = this.mActivity_dmx02;
                if (r34 != 0) {
                    r34.sendTime(this.parameter, i3, r6, hour, minute, this.dayhour, this.dayminute);
                }
            }
            ...
            int i4 = 0;
            for (int i5 = 0; i5 < listDate.size(); i5++) {
                if (listDate.get(i5).getType() == 1) {
                    i4++;
                }
            }
            int i6 = (i4 << 4) | i;
            ...
            if (mainActivity_BLE != null) {
                mainActivity_BLE.sendStageTime(i6, this.dayhour, this.dayminute, hour, minute, this.mod);
                return;
            }
            MainActivity_DMX02 mainActivity_DMX02 = this.mActivity_dmx02;
            if (mainActivity_DMX02 != null) {
                mainActivity_DMX02.sendStageTime(i6, this.dayhour, this.dayminute, hour, minute, this.mod);
            }
        }
    }
}
