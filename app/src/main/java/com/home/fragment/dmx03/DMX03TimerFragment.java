...
public class DMX03TimerFragment extends LedBleFragment {
    private static final String TAG = "DMX03TimerFragment";
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [com.home.activity.main.MainActivity_DMX03] */
