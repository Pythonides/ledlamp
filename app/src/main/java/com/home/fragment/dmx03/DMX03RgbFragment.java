...
public class DMX03RgbFragment extends LedBleFragment {
    ...
    public void initData() {
        ...
        this.imageViewPicker.subscribe(new ColorObserver() { // from class: com.home.fragment.dmx03.DMX03RgbFragment$$ExternalSyntheticLambda0
            ...
            public final void onColor(int i, boolean z, boolean z2) {
                DMX03RgbFragment.this.m29lambda$initData$0$comhomefragmentdmx03DMX03RgbFragment(i, z, z2);
            }
        });
        ...
        this.seekBarBrightNessCT.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.7
        ...
        this.seekBarRedBrightNess.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.8
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i2, boolean z) {
                if (z) {
        ...
        this.seekBarGreenBrightNess.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.9
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
        ...
        this.seekBarBlueBrightNess.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.10
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
        ...
        this.pikerImageViewDim.setOnTouchPixListener(new MyColorPickerImageView.OnTouchPixListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.11
        ...
        this.srgCover.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.12
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.13
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public /* synthetic */ void m29lambda$initData$0$comhomefragmentdmx03DMX03RgbFragment(int i, boolean z, boolean z2) {
        int[] rgb = Tool.getRGB(i);
    ...
    private void initSingColorView() {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.14
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private void initDiyColorBlock() {
        ...
        for (int i = 1; i <= 6; i++) {
            ...
            colorTextView.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    view.startAnimation(AnimationUtils.loadAnimation(DMX03RgbFragment.this.getActivity(), R.anim.layout_scale));
                    ...
                    if (color == 0) {
                        ...
                        if (brightData == 0) {
                            ...
                            handler.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15.1
                        ...
                        handler2.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15.2
                            @Override // java.lang.Runnable
                            public void run() {
                                if (DMX03RgbFragment.this.mActivity != null) {
                        ...
                        if (DMX03RgbFragment.this.mActivity != null) {
                            ...
                            handler3.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15.3
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                        ...
                        if (brightData2 == 0) {
                            ...
                            handler4.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15.5
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                            ...
                            handler5.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15.6
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                        ...
                        if (brightData3 == 0) {
                            ...
                            handler6.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15.7
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                        ...
                        handler7.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.15.8
                            @Override // java.lang.Runnable
                            public void run() {
                                if (DMX03RgbFragment.this.mActivity != null) {
                ...
                /* renamed from: com.home.fragment.dmx03.DMX03RgbFragment$15$4  reason: invalid class name */
                /* loaded from: classes.dex */
            ...
            colorTextView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.16
    ...
    private void initDiyColorCar01DMXBlock() {
        ...
        for (int i = 1; i <= 6; i++) {
            ...
            colorTextView.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    final int i3;
                    view.startAnimation(AnimationUtils.loadAnimation(DMX03RgbFragment.this.getActivity(), R.anim.layout_scale));
                    ...
                    if (color == 0) {
                        ...
                        if (brightData == 0) {
                            final Handler handler = new Handler();
                            handler.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                                        DMX03RgbFragment.this.mActivity.setBrightNess(100, false, DMX03RgbFragment.this.isCAR01LED.booleanValue(), DMX03RgbFragment.this.isCAR01DMX.booleanValue());
                        ...
                        final Handler handler2 = new Handler();
                        handler2.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17.2
                            @Override // java.lang.Runnable
                            public void run() {
                                if (DMX03RgbFragment.this.mActivity != null) {
                                    DMX03RgbFragment.this.mActivity.setBrightNess(brightData, false, DMX03RgbFragment.this.isCAR01LED.booleanValue(), DMX03RgbFragment.this.isCAR01DMX.booleanValue());
                        ...
                        if (DMX03RgbFragment.this.mActivity != null) {
                            ...
                            final Handler handler3 = new Handler();
                            handler3.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17.3
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                                        NetConnectBle.getInstance().setSensitivity(93, false, false, LedBleApplication.getApp().getSceneBean());
                        ...
                        if (brightData2 == 0) {
                            final Handler handler4 = new Handler();
                            handler4.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17.5
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                                        DMX03RgbFragment.this.mActivity.setBrightNessNoInterval(100, DMX03RgbFragment.this.isCAR01LED.booleanValue(), DMX03RgbFragment.this.isCAR01DMX.booleanValue());
                            ...
                            final Handler handler5 = new Handler();
                            handler5.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17.6
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                                        DMX03RgbFragment.this.mActivity.setBrightNessNoInterval(brightData2, DMX03RgbFragment.this.isCAR01LED.booleanValue(), DMX03RgbFragment.this.isCAR01DMX.booleanValue());
                        ...
                        if (i3 == 0) {
                            final Handler handler6 = new Handler();
                            handler6.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17.7
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (DMX03RgbFragment.this.mActivity != null) {
                                        DMX03RgbFragment.this.mActivity.setSpeedNoInterval(85);
                        ...
                        final Handler handler7 = new Handler();
                        handler7.postDelayed(new Runnable() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.17.8
                            @Override // java.lang.Runnable
                            public void run() {
                                if (DMX03RgbFragment.this.mActivity != null) {
                ...
                /* renamed from: com.home.fragment.dmx03.DMX03RgbFragment$17$4  reason: invalid class name */
                /* loaded from: classes.dex */
                class AnonymousClass4 implements Runnable {
                    final /* synthetic */ Handler val$handler;
                    final /* synthetic */ int val$sensitivity2;
            ...
            colorTextView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.18
                @Override // android.view.View.OnLongClickListener
                public boolean onLongClick(View view) {
                    ColorTextView colorTextView2 = (ColorTextView) view;
                    colorTextView2.setColor(0);
    ...
    private void initDiyRingView() {
        ...
        this.imageViewPicker2.subscribe(new ColorObserver() { // from class: com.home.fragment.dmx03.DMX03RgbFragment$$ExternalSyntheticLambda1
            @Override // top.defaults.colorpicker.ColorObserver
            public final void onColor(int i, boolean z, boolean z2) {
                DMX03RgbFragment.this.m30xce5051dc(i, z, z2);
            }
        });
        this.myColor_select.setOnColorChangedListener(new MyColorPicker.OnColorChangedListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.19
            @Override // com.home.view.MyColorPicker.OnColorChangedListener
            public void onColorChanged(int i) {
                int[] rgb = Tool.getRGB(i);
        ...
        this.iv_switch_select.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.20
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        colorPicker.setCallback(new ColorPickerCallback() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.21
            @Override // com.pes.androidmaterialcolorpickerdialog.ColorPickerCallback
            public void onColorChosen(int i) {
                DMX03RgbFragment.this.blackWiteSelectView2.setStartColor(i);
                DMX03RgbFragment.this.currentSelecColorFromPicker = i;
        ...
        colorPicker.enableAutoClose();
        this.linearChouse_select.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.22
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        blackWiteSelectView.setOnSelectColor(new BlackWiteSelectView.OnSelectColor() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.23
            @Override // com.home.view.BlackWiteSelectView.OnSelectColor
            public void onColorSelect(int i, int i2) {
                int i3 = i2 <= 0 ? 1 : i2;
                if (i2 >= 100) {
        ...
        for (int i2 = 1; i2 <= 6; i2++) {
            ...
            findViewWithTag.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.24
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    view.startAnimation(AnimationUtils.loadAnimation(DMX03RgbFragment.this.getActivity(), R.anim.layout_scale));
                    int intValue = ((Integer) view.getTag()).intValue();
    ...
    public /* synthetic */ void m30xce5051dc(int i, boolean z, boolean z2) {
        if (z) {
    ...
    private void initDiyModeView() {
        ...
        wheelPicker.setOnItemSelectedListener(new WheelPicker.OnItemSelectedListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.25
        ...
        this.seekBarModeSC.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.26
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
        ...
        this.seekBarBrightBarSC.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.27
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                if (i == 0) {
        ...
        this.seekBarSpeedBarSC.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.28
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i2, boolean z) {
                if (i2 == 0) {
                    if (DMX03RgbFragment.this.mActivity != null) {
    ...
    private void initDiyVoiceControlView() {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.29
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.30
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DMX03RgbFragment.this.startAnimation(view);
        ...
        linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.31
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DMX03RgbFragment.this.startAnimation(view);
        ...
        linearLayout4.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.32
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DMX03RgbFragment.this.startAnimation(view);
        ...
        this.seekBarSensitivitySC.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.33
    ...
    private void initConfirmButton() {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.dmx03.DMX03RgbFragment.34
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
