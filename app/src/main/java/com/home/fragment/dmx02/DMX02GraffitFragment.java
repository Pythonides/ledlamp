...
public class DMX02GraffitFragment extends LedBleFragment implements ReceiveDataListener {
        ...
        this.sbColor.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx02.DMX02GraffitFragment.4
            ...
            public void onProgressChanged(SeekBar seekBar, int i3, boolean z) {
                if (z) {
                    ...
                    DMX02GraffitFragment.this.mode = 3;
                    NetConnectBle.getInstanceByGroup("").setDmx02GraffitColor(DMX02GraffitFragment.this.mode, DMX02GraffitFragment.this.red, DMX02GraffitFragment.this.green, DMX02GraffitFragment.this.blue);
                    MainActivity_DMX02 mainActivity_DMX02 = DMX02GraffitFragment.this.mActivity;
                    ...
                    sb.append("RGB");
                    SharePersistent.savePerference(mainActivity_DMX02, sb.toString(), DMX02GraffitFragment.this.tvColor.getText().toString());
                    ...
                    sb2.append("RGBValue");
                    SharePersistent.saveInt(context, sb2.toString(), i3);
                }
            }
        });
        if (MainActivity_DMX02.sceneBean != null) {
            MainActivity_DMX02 mainActivity_DMX02 = this.mActivity;
            String perference = SharePersistent.getPerference(mainActivity_DMX02, MainActivity_DMX02.sceneBean + "DMX02GraffitFragmentRGB");
            Context context = getContext();
            int i3 = SharePersistent.getInt(context, MainActivity_DMX02.sceneBean + "DMX02GraffitFragmentRGBValue");
        ...
        this.sbBrightness.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.dmx02.DMX02GraffitFragment.5
            ...
            public void onProgressChanged(SeekBar seekBar, int i4, boolean z) {
                if (z) {
                    ...
                    MainActivity_DMX02 mainActivity_DMX022 = DMX02GraffitFragment.this.mActivity;
                    StringBuilder sb = new StringBuilder();
                    MainActivity_DMX02 unused = DMX02GraffitFragment.this.mActivity;
                    sb.append(MainActivity_DMX02.sceneBean);
                    sb.append("DMX02GraffitFragment");
                    sb.append("bright");
                    SharePersistent.saveInt(mainActivity_DMX022, sb.toString(), i4);
                }
            }
        });
        if (MainActivity_DMX02.sceneBean != null) {
            MainActivity_DMX02 mainActivity_DMX022 = this.mActivity;
            int i4 = SharePersistent.getInt(mainActivity_DMX022, MainActivity_DMX02.sceneBean + "DMX02GraffitFragmentbright");
            if (i4 > 0) {
    ...
    public int getPixSetLong() {
        ...
        if (perference == null || perference.length() <= 0) {
            perference = "16";
            Context context = getContext();
            SharePersistent.savePerference(context, LedBleApplication.getApp().getSceneBean() + "btnSetPixLong", "16");
        }
    ...
    public int getPixSetWidth() {
        ...
        if (perference == null || perference.length() <= 0) {
            perference = "16";
            MainActivity_DMX02 mainActivity_DMX022 = this.mActivity;
            SharePersistent.savePerference(mainActivity_DMX022, LedBleApplication.getApp().getSceneBean() + "btnSetPixWidth", "16");
        }
        return Integer.parseInt(perference);
    }
