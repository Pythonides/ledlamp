...
public class CtFragment_sun_ViewBinding implements Unbinder {
    ...
    public CtFragment_sun_ViewBinding(CtFragment_sun ctFragment_sun, View view) {
        ...
        ctFragment_sun.tvBrightNessSun = (TextView) Utils.findRequiredViewAsType(view, R.id.tvBrightNessSun, "field 'tvBrightNessSun'", TextView.class);
    ...
    public void unbind() {
        ...
        ctFragment_sun.tvBrightNessSun = null;
