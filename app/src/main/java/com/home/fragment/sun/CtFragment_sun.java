...
public class CtFragment_sun extends LedBleFragment {
    ...
    @BindView(R.id.tvBrightNessSun)
    TextView tvBrightNessSun;
    ...
    public void initView() {
        ...
        this.tempControl.setOnTempChangeListener(new TempControlView.OnTempChangeListener() { // from class: com.home.fragment.sun.CtFragment_sun.1
            ...
            public void change(int i) {
                int i2 = 100 - i;
                CtFragment_sun.this.tvBrightNessSun.setText(CtFragment_sun.this.getActivity().getString(R.string.cool_warm, new Object[]{String.valueOf(i2), String.valueOf(i)}));
                ...
                if (CtFragment_sun.this.canSend) {
                    ...
                    CtFragment_sun.this.mActivity.setCT(i, i2);
