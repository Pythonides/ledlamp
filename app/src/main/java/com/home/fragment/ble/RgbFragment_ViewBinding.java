...
public class RgbFragment_ViewBinding implements Unbinder {
    ...
    public RgbFragment_ViewBinding(RgbFragment rgbFragment, View view) {
        ...
        rgbFragment.pikerViewCT = (TempControlView) Utils.findRequiredViewAsType(view, R.id.pikerViewCT, "field 'pikerViewCT'", TempControlView.class);
        ...
        rgbFragment.ll_whitelight = (LinearLayout) Utils.findRequiredViewAsType(view, R.id.ll_whitelight, "field 'll_whitelight'", LinearLayout.class);
        rgbFragment.ll_naturallight = (LinearLayout) Utils.findRequiredViewAsType(view, R.id.ll_naturallight, "field 'll_naturallight'", LinearLayout.class);
        rgbFragment.ll_warmlight = (LinearLayout) Utils.findRequiredViewAsType(view, R.id.ll_warmlight, "field 'll_warmlight'", LinearLayout.class);
        ...
        rgbFragment.pikerViewDIM = (PickerViewDIM) Utils.findRequiredViewAsType(view, R.id.pikerViewDIM, "field 'pikerViewDIM'", PickerViewDIM.class);
        rgbFragment.tvBrightNessDim = (TextView) Utils.findRequiredViewAsType(view, R.id.tvBrightNessDim, "field 'tvBrightNessDim'", TextView.class);
        ...
        rgbFragment.seekBarBrightNessDim = (SeekBar) Utils.findRequiredViewAsType(view, R.id.seekBarBrightNessDim, "field 'seekBarBrightNessDim'", SeekBar.class);
        rgbFragment.tvSeekBarBrightNessDim = (TextView) Utils.findRequiredViewAsType(view, R.id.tvSeekBarBrightNessDim, "field 'tvSeekBarBrightNessDim'", TextView.class);
    }
    ...
    public void unbind() {
        ...
        rgbFragment.pikerViewCT = null;
        rgbFragment.textViewWarmCool = null;
        rgbFragment.seekBarBrightNessCT = null;
        rgbFragment.textViewBrightNessCT = null;
        rgbFragment.ll_whitelight = null;
        rgbFragment.ll_naturallight = null;
        rgbFragment.ll_warmlight = null;
        ...
        rgbFragment.pikerViewDIM = null;
        rgbFragment.tvBrightNessDim = null;
        rgbFragment.pikerImageViewDim = null;
        rgbFragment.seekBarBrightNessDim = null;
        rgbFragment.tvSeekBarBrightNessDim = null;
    }
}
