...
public class RgbFragment extends LedBleFragment {
    ...
    public void initData() {
        ...
        colorPicker.setCallback(new ColorPickerCallback() { // from class: com.home.fragment.ble.RgbFragment.5
            ...
            public void onColorChosen(int i) {
                ...
                RgbFragment.this.updateRgbText(Tool.getRGB(i), false, true, false);
            }
        });
        ...
        this.imageViewPicker.subscribe(new ColorObserver() { // from class: com.home.fragment.ble.RgbFragment$$ExternalSyntheticLambda0
            ...
            public final void onColor(int i, boolean z, boolean z2) {
                RgbFragment.this.m21lambda$initData$0$comhomefragmentbleRgbFragment(i, z, z2);
            }
        });
        this.myColor.setOnColorChangedListener(new MyColorPicker.OnColorChangedListener() { // from class: com.home.fragment.ble.RgbFragment.7
            ...
            public void onColorChanged(int i) {
                ...
                RgbFragment.this.updateRgbText(rgb, false, true, false);
        ...
        this.blackWiteSelectView.setOnSelectColor(new BlackWiteSelectView.OnSelectColor() { // from class: com.home.fragment.ble.RgbFragment.9
            ...
            public void onColorSelect(int i, int i2) {
                ...
                if (MainActivity_BLE.sceneBean != null) {
                    ...
                    SharePersistent.saveInt(mainActivity_BLE, MainActivity_BLE.sceneBean + RgbFragment.TAG, i2);
                }
            }
        });
        ...
        if (MainActivity_BLE.sceneBean != null) {
            ...
            int i = SharePersistent.getInt(mainActivity_BLE, MainActivity_BLE.sceneBean + TAG);
            if (i > 0) {
        ...
        this.pikerViewCT.setOnTempChangeListener(new TempControlView.OnTempChangeListener() { // from class: com.home.fragment.ble.RgbFragment.10
            @Override // com.common.view.TempControlView.OnTempChangeListener
            public void change(int i2) {
                int i3 = 100 - i2;
                RgbFragment.this.textViewWarmCool.setText(RgbFragment.this.getActivity().getString(R.string.cool_warm, new Object[]{String.valueOf(i3), String.valueOf(i2)}));
                if (RgbFragment.this.mActivity != null) {
                    RgbFragment.this.mActivity.setCT(i2, i3);
                }
            }
        });
        this.pikerViewCT.setOnClickListener(new TempControlView.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.11
            @Override // com.common.view.TempControlView.OnClickListener
            public void onClick(int i2) {
            }
        });
        this.seekBarBrightNessCT.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.12
        ...
        this.ll_whitelight.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.13
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RgbFragment rgbFragment = RgbFragment.this;
                rgbFragment.sendCMD(view, rgbFragment.getString(R.string.white_light), 0);
            }
        });
        this.ll_naturallight.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.14
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RgbFragment rgbFragment = RgbFragment.this;
                rgbFragment.sendCMD(view, rgbFragment.getString(R.string.natural_light), 50);
            }
        });
        this.ll_warmlight.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.15
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RgbFragment rgbFragment = RgbFragment.this;
                rgbFragment.sendCMD(view, rgbFragment.getString(R.string.warm_light), 100);
            }
        });
        this.seekBarRedBrightNess.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.16
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i2, boolean z) {
                if (z) {
                    ...
                    if (RgbFragment.this.mActivity != null) {
                        RgbFragment.this.mActivity.setSmartBrightness(i2, 1);
                    }
                    if (MainActivity_BLE.sceneBean != null) {
                        MainActivity_BLE mainActivity_BLE2 = RgbFragment.this.mActivity;
                        SharePersistent.saveInt(mainActivity_BLE2, MainActivity_BLE.sceneBean + RgbFragment.TAG + "red-aisle", i2);
                    }
                }
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (RgbFragment.this.mActivity != null) {
                    RgbFragment.this.mActivity.setSmartBrightnessNoInterval(RgbFragment.this.redBrightNessValue, 1);
                }
            }
        });
        if (MainActivity_BLE.sceneBean != null) {
            MainActivity_BLE mainActivity_BLE2 = this.mActivity;
            int i2 = SharePersistent.getInt(mainActivity_BLE2, MainActivity_BLE.sceneBean + TAG + "red-aisle");
            if (i2 >= 0) {
        ...
        this.seekBarGreenBrightNess.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.17
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i3, boolean z) {
                if (z) {
                    ...
                    if (RgbFragment.this.mActivity != null) {
                        RgbFragment.this.mActivity.setSmartBrightness(i3, 2);
                    }
                    if (MainActivity_BLE.sceneBean != null) {
                        MainActivity_BLE mainActivity_BLE3 = RgbFragment.this.mActivity;
                        SharePersistent.saveInt(mainActivity_BLE3, MainActivity_BLE.sceneBean + RgbFragment.TAG + "green-aisle", i3);
                    }
                }
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (RgbFragment.this.mActivity != null) {
                    RgbFragment.this.mActivity.setSmartBrightnessNoInterval(RgbFragment.this.greenBrightNessValue, 2);
                }
            }
        });
        if (MainActivity_BLE.sceneBean != null) {
            MainActivity_BLE mainActivity_BLE3 = this.mActivity;
            int i3 = SharePersistent.getInt(mainActivity_BLE3, MainActivity_BLE.sceneBean + TAG + "green-aisle");
            if (i3 >= 0) {
        ...
        this.seekBarBlueBrightNess.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.18
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i4, boolean z) {
                if (z) {
                    ...
                    if (RgbFragment.this.mActivity != null) {
                        RgbFragment.this.mActivity.setSmartBrightness(i4, 3);
                    }
                    if (MainActivity_BLE.sceneBean != null) {
                        MainActivity_BLE mainActivity_BLE4 = RgbFragment.this.mActivity;
                        SharePersistent.saveInt(mainActivity_BLE4, MainActivity_BLE.sceneBean + RgbFragment.TAG + "blue-aisle", i4);
                    }
                }
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (RgbFragment.this.mActivity != null) {
                    RgbFragment.this.mActivity.setSmartBrightnessNoInterval(RgbFragment.this.blueBrightNessValue, 3);
                }
            }
        });
        if (MainActivity_BLE.sceneBean != null) {
            MainActivity_BLE mainActivity_BLE4 = this.mActivity;
            int i4 = SharePersistent.getInt(mainActivity_BLE4, MainActivity_BLE.sceneBean + TAG + "blue-aisle");
            if (i4 >= 0) {
        ...
        this.pikerImageViewDim.setOnTouchPixListener(new MyColorPickerImageView.OnTouchPixListener() { // from class: com.home.fragment.ble.RgbFragment.19
            ...
            public void onColorSelect(int i5, float f) {
                ...
                TextView textView = RgbFragment.this.tvBrightNessDim;
        ...
        this.pikerViewDIM.setOnTempChangeListener(new PickerViewDIM.OnTempChangeListener() { // from class: com.home.fragment.ble.RgbFragment.20
            @Override // com.common.view.PickerViewDIM.OnTempChangeListener
            public void change(int i5) {
                TextView textView = RgbFragment.this.tvBrightNessDim;
                textView.setText(RgbFragment.this.getActivity().getResources().getString(R.string.brightness) + ":" + i5);
                if (RgbFragment.this.mActivity != null) {
                    RgbFragment.this.mActivity.setDim(i5);
                }
            }
        });
        this.pikerViewDIM.setOnClickListener(new PickerViewDIM.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.21
            @Override // com.common.view.PickerViewDIM.OnClickListener
            public void onClick(int i5) {
            }
        });
        this.seekBarBrightNessDim.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.22
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i5, boolean z) {
                if (i5 == 0) {
                    RgbFragment.this.tvSeekBarBrightNessDim.setText(RgbFragment.this.getActivity().getResources().getString(R.string.brightness_set, String.valueOf(1)));
                    seekBar.setProgress(1);
                    if (RgbFragment.this.mActivity != null) {
                        RgbFragment.this.mActivity.setBrightNess(1, false, RgbFragment.this.isCAR01LED.booleanValue(), RgbFragment.this.isCAR01DMX.booleanValue());
                        return;
                ...
                RgbFragment.this.tvSeekBarBrightNessDim.setText(RgbFragment.this.getActivity().getResources().getString(R.string.brightness_set, String.valueOf(i5)));
                if (RgbFragment.this.mActivity != null) {
        ...
        this.srgCover.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.home.fragment.ble.RgbFragment.23
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
        ...
        this.srgCoverStage.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.home.fragment.ble.RgbFragment.24
            @Override // android.widget.RadioGroup.OnCheckedChangeListener
            public void onCheckedChanged(RadioGroup radioGroup, int i5) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.25
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public /* synthetic */ void m21lambda$initData$0$comhomefragmentbleRgbFragment(int i, boolean z, boolean z2) {
        int[] rgb = Tool.getRGB(i);
        ...
        if (z) {
            updateRgbText(Tool.getRGB(i), false, true, false);
        }
    }
    ...
    private void initSingColorView() {
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.26
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                view.startAnimation(AnimationUtils.loadAnimation(RgbFragment.this.getActivity(), R.anim.layout_scale));
                int intValue = ((Integer) view.getTag()).intValue();
                RgbFragment.this.updateRgbText(Tool.getRGB(intValue), true, false, false);
    ...
    private void initDiyColorBlock() {
        ...
        for (int i = 1; i <= 6; i++) {
            ...
            colorTextView.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.27
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    final int i3;
                    final int i4;
                    ...
                    if (color == 0) {
                        ...
                        if (RgbFragment.this.mActivity != null) {
                            i5 = SharePersistent.getBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "bright" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "bright" + MainActivity_BLE.sceneBean);
                        } else {
                            i5 = 0;
                        }
                        if (RgbFragment.this.mActivity != null) {
                            RgbFragment.this.updateRgbText(rgb, true, false, false);
                        }
                        if (i5 == 0) {
                            final Handler handler = new Handler();
                            handler.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.1
                        ...
                        handler2.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.2
                            @Override // java.lang.Runnable
                            public void run() {
                                if (RgbFragment.this.mActivity != null) {
                                    RgbFragment.this.mActivity.setBrightNess(i5, false, RgbFragment.this.isCAR01LED.booleanValue(), RgbFragment.this.isCAR01DMX.booleanValue());
                        ...
                        if (RgbFragment.this.mActivity != null) {
                            final int brightData = SharePersistent.getBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "sensitivity" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "sensitivity" + MainActivity_BLE.sceneBean);
                            if (RgbFragment.this.mActivity != null) {
                                RgbFragment.this.mActivity.setMode(true, false, false, color - RgbFragment.this.VCTAG);
                            }
                            if (brightData == 0) {
                                final Handler handler3 = new Handler();
                                handler3.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.3
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        if (RgbFragment.this.mActivity != null) {
                            ...
                            handler4.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.4
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                        ...
                        if (RgbFragment.this.mActivity != null) {
                            i3 = SharePersistent.getBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "bright" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "bright" + MainActivity_BLE.sceneBean);
                        } else {
                            i3 = 0;
                        }
                        if (RgbFragment.this.mActivity != null) {
                            i4 = SharePersistent.getBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "speed" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "speed" + MainActivity_BLE.sceneBean);
                        } else {
                            i4 = 0;
                        }
                        if (RgbFragment.this.mActivity != null) {
                        ...
                        if (i3 == 0) {
                            ...
                            handler5.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.5
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                            ...
                            handler6.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.6
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                        ...
                        if (i4 == 0) {
                            ...
                            handler7.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.7
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                        ...
                        handler8.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.27.8
                            @Override // java.lang.Runnable
                            public void run() {
                                if (RgbFragment.this.mActivity != null) {
            ...
            colorTextView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.home.fragment.ble.RgbFragment.28
    ...
    private void initDiyColorCar01DMXBlock() {
        ...
        for (int i = 1; i <= 6; i++) {
            ...
            colorTextView.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.29
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    final int i3;
                    final int i4;
                    ...
                    if (color == 0) {
                        ...
                        if (i5 == 0) {
                            final Handler handler = new Handler();
                            handler.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                                        RgbFragment.this.mActivity.setBrightNess(100, false, RgbFragment.this.isCAR01LED.booleanValue(), RgbFragment.this.isCAR01DMX.booleanValue());
                        ...
                        final Handler handler2 = new Handler();
                        handler2.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.2
                            @Override // java.lang.Runnable
                            public void run() {
                                if (RgbFragment.this.mActivity != null) {
                                    RgbFragment.this.mActivity.setBrightNess(i5, false, RgbFragment.this.isCAR01LED.booleanValue(), RgbFragment.this.isCAR01DMX.booleanValue());
                        ...
                        if (RgbFragment.this.mActivity != null) {
                            ...
                            if (brightData == 0) {
                                final Handler handler3 = new Handler();
                                handler3.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.3
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        if (RgbFragment.this.mActivity != null) {
                                            NetConnectBle.getInstance().setSensitivity(93, false, false, MainActivity_BLE.sceneBean);
                            ...
                            final Handler handler4 = new Handler();
                            handler4.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.4
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                                        NetConnectBle.getInstance().setSensitivity(brightData, false, false, MainActivity_BLE.sceneBean);
                        ...
                        if (i3 == 0) {
                            final Handler handler5 = new Handler();
                            handler5.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.5
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                                        RgbFragment.this.mActivity.setBrightNessNoInterval(100, RgbFragment.this.isCAR01LED.booleanValue(), RgbFragment.this.isCAR01DMX.booleanValue());
                            ...
                            final Handler handler6 = new Handler();
                            handler6.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.6
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                                        RgbFragment.this.mActivity.setBrightNessNoInterval(i3, RgbFragment.this.isCAR01LED.booleanValue(), RgbFragment.this.isCAR01DMX.booleanValue());
                        ...
                        if (i4 == 0) {
                            final Handler handler7 = new Handler();
                            handler7.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.7
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (RgbFragment.this.mActivity != null) {
                                        RgbFragment.this.mActivity.setSpeedNoInterval(85);
                        ...
                        final Handler handler8 = new Handler();
                        handler8.postDelayed(new Runnable() { // from class: com.home.fragment.ble.RgbFragment.29.8
                            @Override // java.lang.Runnable
                            public void run() {
                                if (RgbFragment.this.mActivity != null) {
                                    RgbFragment.this.mActivity.setSpeedNoInterval(i4);
            ...
            colorTextView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.home.fragment.ble.RgbFragment.30
                @Override // android.view.View.OnLongClickListener
                public boolean onLongClick(View view) {
                    ColorTextView colorTextView2 = (ColorTextView) view;
                    colorTextView2.setColor(0);
    ...
    private void initDiyRingView() {
        ...
        this.imageViewPicker2.subscribe(new ColorObserver() { // from class: com.home.fragment.ble.RgbFragment$$ExternalSyntheticLambda1
            @Override // top.defaults.colorpicker.ColorObserver
            public final void onColor(int i, boolean z, boolean z2) {
                RgbFragment.this.m22lambda$initDiyRingView$1$comhomefragmentbleRgbFragment(i, z, z2);
            }
        });
        this.myColor_select.setOnColorChangedListener(new MyColorPicker.OnColorChangedListener() { // from class: com.home.fragment.ble.RgbFragment.31
            @Override // com.home.view.MyColorPicker.OnColorChangedListener
            public void onColorChanged(int i) {
                int[] rgb = Tool.getRGB(i);
                ...
                if (RgbFragment.this.mActivity != null) {
                    SharePersistent.saveBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "bright" + CommonConstant.LEDBLE, RgbFragment.this.diyViewTag + "bright" + CommonConstant.LEDBLE, RgbFragment.this.brightnessValue);
                }
            }
        });
        this.iv_switch_select.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.32
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        colorPicker.setCallback(new ColorPickerCallback() { // from class: com.home.fragment.ble.RgbFragment.33
            @Override // com.pes.androidmaterialcolorpickerdialog.ColorPickerCallback
            public void onColorChosen(int i) {
                RgbFragment.this.blackWiteSelectView2.setStartColor(i);
                RgbFragment.this.currentSelecColorFromPicker = i;
        ...
        colorPicker.enableAutoClose();
        this.linearChouse_select.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.34
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        blackWiteSelectView.setOnSelectColor(new BlackWiteSelectView.OnSelectColor() { // from class: com.home.fragment.ble.RgbFragment.35
            @Override // com.home.view.BlackWiteSelectView.OnSelectColor
            public void onColorSelect(int i, int i2) {
                int i3 = i2 <= 0 ? 1 : i2;
                if (i2 >= 100) {
                ...
                if (RgbFragment.this.mActivity != null) {
                    ...
                    SharePersistent.saveBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "bright" + CommonConstant.LEDBLE, RgbFragment.this.diyViewTag + "bright" + CommonConstant.LEDBLE, i3);
                }
                if (MainActivity_BLE.sceneBean != null) {
                    SharePersistent.saveInt(RgbFragment.this.mActivity, MainActivity_BLE.sceneBean + RgbFragment.TAG + "DIY", i3);
                }
            }
        });
        ...
        if (MainActivity_BLE.sceneBean != null) {
            MainActivity_BLE mainActivity_BLE = this.mActivity;
            int i = SharePersistent.getInt(mainActivity_BLE, MainActivity_BLE.sceneBean + TAG + "DIY");
            if (i > 0) {
        ...
        for (int i2 = 1; i2 <= 6; i2++) {
            ...
            findViewWithTag.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.36
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    view.startAnimation(AnimationUtils.loadAnimation(RgbFragment.this.getActivity(), R.anim.layout_scale));
                    int intValue = ((Integer) view.getTag()).intValue();
    ...
    public /* synthetic */ void m22lambda$initDiyRingView$1$comhomefragmentbleRgbFragment(int i, boolean z, boolean z2) {
        if (z) {
            ...
            int[] rgb = Tool.getRGB(i);
            updateRgbText(rgb, false, false, false);
            this.select_r = rgb[0];
            this.select_g = rgb[1];
            this.select_b = rgb[2];
            ...
            if (mainActivity_BLE != null) {
                SharePersistent.saveBrightData(mainActivity_BLE, this.diyViewTag + "bright" + CommonConstant.LEDBLE, this.diyViewTag + "bright" + CommonConstant.LEDBLE, this.brightnessValue);
            }
        }
    }
    ...
    private void initDiyModeView() {
        ...
        this.wheelPicker_tang.setOnItemSelectedListener(new WheelPicker.OnItemSelectedListener() { // from class: com.home.fragment.ble.RgbFragment.37
        ...
        this.seekBarModeSC.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.38
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
        ...
        this.seekBarBrightBarSC.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.39
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                if (i == 0) {
                    ...
                    if (RgbFragment.this.mActivity != null) {
                        RgbFragment.this.mActivity.setBrightNess(1, false, RgbFragment.this.isCAR01LED.booleanValue(), RgbFragment.this.isCAR01DMX.booleanValue());
                        SharePersistent.saveBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "bright" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "bright" + MainActivity_BLE.sceneBean, 1);
                    }
                } else {
                ...
                if (MainActivity_BLE.sceneBean != null) {
                    ...
                    SharePersistent.saveInt(RgbFragment.this.mActivity, MainActivity_BLE.sceneBean + RgbFragment.TAG + "DIYbright", i);
                }
            }
        });
        if (MainActivity_BLE.sceneBean != null) {
            MainActivity_BLE mainActivity_BLE = this.mActivity;
            int i = SharePersistent.getInt(mainActivity_BLE, MainActivity_BLE.sceneBean + TAG + "DIYbright");
            if (i > 0) {
        ...
        this.seekBarSpeedBarSC.setOnSeekBarChangeListener(new OnSeekBarChangeListenerAdapter() { // from class: com.home.fragment.ble.RgbFragment.40
            @Override // com.common.adapter.OnSeekBarChangeListenerAdapter, android.widget.SeekBar.OnSeekBarChangeListener
            public void onProgressChanged(SeekBar seekBar, int i2, boolean z) {
                if (i2 == 0) {
                    if (RgbFragment.this.mActivity != null) {
                        RgbFragment.this.mActivity.setSpeed(1, false, RgbFragment.this.isCAR01DMX.booleanValue());
                        SharePersistent.saveBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "speed" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "speed" + MainActivity_BLE.sceneBean, 1);
                    }
                } else {
                    ...
                    if (RgbFragment.this.mActivity != null) {
                        ...
                        SharePersistent.saveBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "speed" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "speed" + MainActivity_BLE.sceneBean, i2);
                    }
                }
                if (MainActivity_BLE.sceneBean != null) {
                    SharePersistent.saveInt(RgbFragment.this.mActivity, MainActivity_BLE.sceneBean + RgbFragment.TAG + "DIYspeed", i2);
                }
            }
        });
        if (MainActivity_BLE.sceneBean != null) {
            MainActivity_BLE mainActivity_BLE2 = this.mActivity;
            int i2 = SharePersistent.getInt(mainActivity_BLE2, MainActivity_BLE.sceneBean + TAG + "DIYspeed");
            if (i2 > 0) {
    ...
    private void initDiyVoiceControlView() {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.41
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
        ...
        linearLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.42
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RgbFragment.this.startAnimation(view);
        ...
        linearLayout3.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.43
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RgbFragment.this.startAnimation(view);
        ...
        linearLayout4.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.44
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                RgbFragment.this.startAnimation(view);
        ...
        this.seekBarSensitivitySC.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() { // from class: com.home.fragment.ble.RgbFragment.45
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                if (z) {
                    if (i == 0) {
                        ...
                        SharePersistent.saveBrightData(RgbFragment.this.mActivity, RgbFragment.this.diyViewTag + "sensitivity" + MainActivity_BLE.sceneBean, RgbFragment.this.diyViewTag + "sensitivity" + MainActivity_BLE.sceneBean, 1);
                    } else {
        ...
        if (MainActivity_BLE.sceneBean != null) {
            MainActivity_BLE mainActivity_BLE = this.mActivity;
            int i = SharePersistent.getInt(mainActivity_BLE, MainActivity_BLE.sceneBean + TAG + "DIYsensitivity");
            if (i > 0) {
    ...
    private void initConfirmButton() {
        ...
        button.setOnClickListener(new View.OnClickListener() { // from class: com.home.fragment.ble.RgbFragment.46
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    public void updateRgbText(int[] iArr, boolean z, boolean z2, boolean z3) {
        try {
            if (this.mActivity != null) {
                if (!MainActivity_BLE.sceneBean.equalsIgnoreCase("LEDDMX-00-") && !MainActivity_BLE.sceneBean.equalsIgnoreCase("LEDDMX-01-")) {
                    this.mActivity.setRgb(iArr[0], iArr[1], iArr[2], z2, this.isCAR01DMX.booleanValue(), this.isCAR01LED.booleanValue(), z, false);
                }
                this.mActivity.setDmx00Dmx01Rgb(iArr[0], iArr[1], iArr[2], z2, z3, false, 0);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
