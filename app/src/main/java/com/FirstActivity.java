...
public class FirstActivity extends LedBleActivity implements View.OnClickListener, MyPersonalFragment.ExitCallBack {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imageViewAdd /* 2131296648 */:
            ...
            case R.id.ivTutorial /* 2131296761 */:
                startActivity(new Intent(getApplicationContext(), HelpActivity.class));
                return;
            case R.id.tabForum /* 2131297454 */:
                this.currentIndex = 1;
                this.tvTitle.setVisibility(8);
                this.ivTutorial.setVisibility(8);
                ll_tab_item.setVisibility(0);
                homeFragment.canShowToast = true;
                videoFragment.canShowToast = false;
                this.myPersonalFragment.canShowToast = false;
                showFragment();
                return;
            case R.id.tabHome /* 2131297455 */:
                this.currentIndex = 0;
                this.tvTitle.setVisibility(0);
                this.tvTitle.setText(getString(R.string.main_tab_text_service));
                this.ivTutorial.setVisibility(0);
                ll_tab_item.setVisibility(8);
                homeFragment.canShowToast = false;
                videoFragment.canShowToast = false;
                this.myPersonalFragment.canShowToast = false;
                showFragment();
                return;
            case R.id.tabPersonal /* 2131297457 */:
                this.currentIndex = 3;
                this.tvTitle.setVisibility(0);
                ...
                homeFragment.canShowToast = false;
                videoFragment.canShowToast = false;
                this.myPersonalFragment.canShowToast = true;
                showFragment();
                return;
            case R.id.tabVideo /* 2131297458 */:
                this.currentIndex = 2;
                this.ivTutorial.setVisibility(0);
                if (this.bl) {
                ...
                ll_tab_item.setVisibility(8);
                homeFragment.canShowToast = false;
                videoFragment.canShowToast = true;
                this.myPersonalFragment.canShowToast = false;
                showFragment();
                return;
            default:
