...
public class LineChartView extends AbstractChartView implements LineChartDataProvider {
    ...
    public interface ReturnValueCallback {
        void returnValue(int i, boolean z);
            ...
            if (action == 0) {
                ...
                if (x != 6.0f && x != 0.0f) {
                    ...
                    if (returnValueCallback != null) {
                        returnValueCallback.returnValue((int) this.yy, false);
                    }
                }
            } else if (action == 1) {
                ...
                if (x2 != 6.0f && x2 != 0.0f) {
                    ...
                    if (d > 0.2d || d < -0.2d || f > 5.0f || f < -5.0f) {
                        ...
                        if (returnValueCallback2 != null) {
                            returnValueCallback2.returnValue((int) bottom, true);
                        }
                    }
                ...
                if (x3 != 6.0f && x3 != 0.0f) {
                    ...
                    if ((d2 > 0.2d || d2 < -0.2d || f2 > 2.0f || f2 < -2.0f) && this.dowm) {
                        ...
                        if (returnValueCallback3 != null) {
                            returnValueCallback3.returnValue((int) bottom2, false);
                        }
                    }
                }
            }
    ...
    public void setSize(int i) {
        if (isChange) {
            ...
            ReturnValueCallback returnValueCallback = this.mReturnValueCallback;
            if (returnValueCallback != null) {
                returnValueCallback.returnValue(i, false);
            }
            invalidate();
        }
    }
    ...
    */
    public java.util.ArrayList start(float r21, int r22) {
        /*
            Method dump skipped, instructions count: 1453
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.example.linechartlibrary.LineChartView.start(float, int):java.util.ArrayList");
    }
