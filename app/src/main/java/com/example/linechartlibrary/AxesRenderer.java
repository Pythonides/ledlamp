...
public class AxesRenderer {
    ...
    */
    private void drawAxisLabelsAndName(android.graphics.Canvas r13, com.example.linechartlibrary.Axis r14, int r15) {
        /*
            Method dump skipped, instructions count: 236
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.example.linechartlibrary.AxesRenderer.drawAxisLabelsAndName(android.graphics.Canvas, com.example.linechartlibrary.Axis, int):void");
    }
