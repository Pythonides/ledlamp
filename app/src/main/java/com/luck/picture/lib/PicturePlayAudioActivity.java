...
public class PicturePlayAudioActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.handler.postDelayed(new Runnable() { // from class: com.luck.picture.lib.PicturePlayAudioActivity$$ExternalSyntheticLambda0
            ...
            public final void run() {
                PicturePlayAudioActivity.this.m37lambda$onCreate$0$comluckpicturelibPicturePlayAudioActivity();
            }
        }, 30L);
    ...
    public /* synthetic */ void m37lambda$onCreate$0$comluckpicturelibPicturePlayAudioActivity() {
