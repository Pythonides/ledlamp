...
public class Luban implements Handler.Callback {
        ...
        while (it.hasNext()) {
            ...
            AsyncTask.SERIAL_EXECUTOR.execute(new Runnable() { // from class: com.luck.picture.lib.compress.Luban$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    Luban.this.m53lambda$launch$0$comluckpicturelibcompressLuban(context, next);
                }
            });
            it.remove();
        }
    ...
    public /* synthetic */ void m53lambda$launch$0$comluckpicturelibcompressLuban(Context context, InputStreamProvider inputStreamProvider) {
        try {
            boolean z = true;
            this.index++;
