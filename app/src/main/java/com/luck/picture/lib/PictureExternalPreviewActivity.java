...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    private Handler handler = new Handler() { // from class: com.luck.picture.lib.PictureExternalPreviewActivity.2
        {
            PictureExternalPreviewActivity.this = this;
        }
    ...
    public class SimpleFragmentAdapter extends PagerAdapter {
        ...
        public SimpleFragmentAdapter() {
            PictureExternalPreviewActivity.this = r1;
        }
            ...
            if (localMedia != null) {
                ...
                photoView.setOnViewTapListener(new OnViewTapListener() { // from class: com.luck.picture.lib.PictureExternalPreviewActivity$SimpleFragmentAdapter$$ExternalSyntheticLambda2
                    ...
                    public final void onViewTap(View view, float f, float f2) {
                        PictureExternalPreviewActivity.SimpleFragmentAdapter.this.m34x43ca1726(view, f, f2);
                    }
                });
                subsamplingScaleImageView.setOnClickListener(new View.OnClickListener() { // from class: com.luck.picture.lib.PictureExternalPreviewActivity$SimpleFragmentAdapter$$ExternalSyntheticLambda0
                    ...
                    public final void onClick(View view) {
                        PictureExternalPreviewActivity.SimpleFragmentAdapter.this.m35x777841e7(view);
                    }
                });
                photoView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.luck.picture.lib.PictureExternalPreviewActivity$SimpleFragmentAdapter$$ExternalSyntheticLambda1
                    ...
                    public final boolean onLongClick(View view) {
                        return PictureExternalPreviewActivity.SimpleFragmentAdapter.this.m36xab266ca8(compressPath, view);
                    }
                });
            }
        ...
        /* renamed from: lambda$instantiateItem$0$com-luck-picture-lib-PictureExternalPreviewActivity$SimpleFragmentAdapter */
        public /* synthetic */ void m34x43ca1726(View view, float f, float f2) {
            PictureExternalPreviewActivity.this.finish();
            PictureExternalPreviewActivity.this.exitAnimation();
        }

        /* renamed from: lambda$instantiateItem$1$com-luck-picture-lib-PictureExternalPreviewActivity$SimpleFragmentAdapter */
        public /* synthetic */ void m35x777841e7(View view) {
            PictureExternalPreviewActivity.this.finish();
            PictureExternalPreviewActivity.this.exitAnimation();
        }

        /* renamed from: lambda$instantiateItem$2$com-luck-picture-lib-PictureExternalPreviewActivity$SimpleFragmentAdapter */
        public /* synthetic */ boolean m36xab266ca8(String str, View view) {
    ...
    public void showDownLoadDialog() {
        ...
        ((Button) pictureCustomDialog.findViewById(R.id.btn_cancel)).setOnClickListener(new View.OnClickListener() { // from class: com.luck.picture.lib.PictureExternalPreviewActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PictureExternalPreviewActivity.lambda$showDownLoadDialog$0(PictureCustomDialog.this, view);
            }
        });
        ((Button) pictureCustomDialog.findViewById(R.id.btn_commit)).setOnClickListener(new View.OnClickListener() { // from class: com.luck.picture.lib.PictureExternalPreviewActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PictureExternalPreviewActivity.this.m33x2eaaba08(pictureCustomDialog, view);
            }
        });
        pictureCustomDialog.show();
    }

    public static /* synthetic */ void lambda$showDownLoadDialog$0(PictureCustomDialog pictureCustomDialog, View view) {
        pictureCustomDialog.dismiss();
    }

    /* renamed from: lambda$showDownLoadDialog$1$com-luck-picture-lib-PictureExternalPreviewActivity */
    public /* synthetic */ void m33x2eaaba08(PictureCustomDialog pictureCustomDialog, View view) {
