...
public class FolderPopWindow extends PopupWindow {
    ...
    public void initView() {
        ...
        this.rootView.setOnClickListener(new View.OnClickListener() { // from class: com.luck.picture.lib.widget.FolderPopWindow$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                FolderPopWindow.this.m56lambda$initView$0$comluckpicturelibwidgetFolderPopWindow(view);
            }
        });
    }
    ...
    public /* synthetic */ void m56lambda$initView$0$comluckpicturelibwidgetFolderPopWindow(View view) {
        dismiss();
    }
    ...
    private void dismiss4Pop() {
        new Handler().post(new Runnable() { // from class: com.luck.picture.lib.widget.FolderPopWindow$$ExternalSyntheticLambda1
            ...
            public final void run() {
                FolderPopWindow.this.m55lambda$dismiss4Pop$1$comluckpicturelibwidgetFolderPopWindow();
            }
        });
    }
    ...
    public /* synthetic */ void m55lambda$dismiss4Pop$1$comluckpicturelibwidgetFolderPopWindow() {
        super.dismiss();
    }
