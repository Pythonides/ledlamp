    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        switch (i) {
            case R.id.rb_all /* 2131297146 */:
                ...
                return;
            case R.id.rb_audio /* 2131297147 */:
                this.chooseMode = PictureMimeType.ofAudio();
                this.cb_preview_audio.setVisibility(0);
                return;
            case R.id.rb_crop_16to9 /* 2131297148 */:
                this.aspect_ratio_x = 16;
                this.aspect_ratio_y = 9;
                return;
            case R.id.rb_crop_1to1 /* 2131297149 */:
                this.aspect_ratio_x = 1;
                this.aspect_ratio_y = 1;
                return;
            case R.id.rb_crop_3to2 /* 2131297150 */:
                this.aspect_ratio_x = 3;
                this.aspect_ratio_y = 2;
                return;
            case R.id.rb_crop_3to4 /* 2131297151 */:
                this.aspect_ratio_x = 3;
                this.aspect_ratio_y = 4;
                return;
            case R.id.rb_crop_default /* 2131297152 */:
                this.aspect_ratio_x = 0;
                this.aspect_ratio_y = 0;
                return;
            case R.id.rb_de /* 2131297153 */:
                this.language = 4;
                return;
            case R.id.rb_default_style /* 2131297154 */:
                this.themeId = 2131821094;
                getDefaultStyle();
                return;
            case R.id.rb_fr /* 2131297155 */:
                this.language = 5;
                return;
            case R.id.rb_image /* 2131297156 */:
                ...
                this.cb_isGif.setVisibility(0);
                return;
            case R.id.rb_ka /* 2131297157 */:
                this.language = 3;
                return;
            case R.id.rb_num_style /* 2131297158 */:
                this.themeId = R.style.picture_QQ_style;
                getNumStyle();
                return;
            case R.id.rb_sina_style /* 2131297159 */:
                this.themeId = R.style.picture_Sina_style;
                getSinaStyle();
                return;
            case R.id.rb_tw /* 2131297160 */:
                this.language = 1;
                return;
            case R.id.rb_us /* 2131297161 */:
                this.language = 2;
                return;
            case R.id.rb_video /* 2131297162 */:
                ...
                return;
            case R.id.rb_white_style /* 2131297163 */:
                this.themeId = R.style.picture_white_style;
                getWhiteStyle();
                return;
            case R.id.rb_zh /* 2131297164 */:
                this.language = 0;
                return;
            default:
                return;
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        switch (compoundButton.getId()) {
            case R.id.cb_crop /* 2131296445 */:
                ...
                return;
            case R.id.cb_crop_circular /* 2131296446 */:
                if (z) {
