...
public class SettingActivity extends LedBleActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.layoutDownloadCenter /* 2131296822 */:
                intent.setClass(this, WebViewActivity.class);
                startActivityForResult(intent, 1);
                return;
            case R.id.layoutHelp /* 2131296823 */:
                intent.setClass(this, AboutusActivity.class);
                intent.putExtra("name", getResources().getString(R.string.about_us_and_help));
                startActivityForResult(intent, 1);
                return;
            case R.id.llAccountSecurity /* 2131296879 */:
                intent.setClass(this, AccountSecurityActivity.class);
                startActivityForResult(intent, 1);
                return;
            case R.id.llPassword /* 2131296920 */:
                intent.setClass(this, PasswordActivity.class);
                startActivityForResult(intent, 1);
                return;
            case R.id.rlSwitchLanguage /* 2131297238 */:
