    ...
    public void update(List<? extends PyEntity> list) {
        ...
        Collections.sort(this.entityList, new Comparator() { // from class: com.sahooz.library.countrypicker.PyAdapter$$ExternalSyntheticLambda1
            ...
            public final int compare(Object obj, Object obj2) {
                return PyAdapter.this.m66lambda$update$1$comsahoozlibrarycountrypickerPyAdapter((PyEntity) obj, (PyEntity) obj2);
            }
        });
        notifyDataSetChanged();
    }

    /* renamed from: lambda$update$1$com-sahooz-library-countrypicker-PyAdapter */
    public /* synthetic */ int m66lambda$update$1$comsahoozlibrarycountrypickerPyAdapter(PyEntity pyEntity, PyEntity pyEntity2) {
